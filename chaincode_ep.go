...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	return shim.Error("Invalid invoke function name. Expecting \"invoke\" \"delete\" \"query\"  \"endorsement\"  \"add\"")
}
...
func (t *SimpleChaincode) endorsement(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 2 {
...
func (t *SimpleChaincode) add(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	keyVal, _ := strconv.Atoi(string(keybytes))
	changeVal, err := strconv.Atoi(change)
	if err != nil {
		return shim.Error(err.Error())
	}

	fmt.Printf("val = %d, change = %d\n", keyVal, changeVal)
	keyVal += changeVal
